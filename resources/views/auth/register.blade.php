                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        value="{{ old('telefono') }}" required autocomplete="telefono" placeholder="Numero" autofocus>
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" class="form-control"
                                        name="password_confirmation" required autocomplete="new-password" placeholder="Confirmar contraseña">
                                </div>
                            </div>
