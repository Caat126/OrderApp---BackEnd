                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="{{ $negocio->nombre }}" name="nombre">
                            @error('nombre')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="descripcion" cols="30" rows="3">{{ $negocio->descripcion }}</textarea>
                            @error('descripcion')
                                <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div>
