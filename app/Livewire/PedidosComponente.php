...
class PedidosComponente extends Component
{
    ...
    public function guardarPedido(){
        ...
        if($pedido->save()){
            ...
            session()->flash('success', 'Se ha registrado el pedido');
            $this->reset(['cliente_id', 'negocio_id', 'total', 'carrito']);
        } else {
            session()->flash('error', 'Error al registrar pedido');
        }
    }
}
